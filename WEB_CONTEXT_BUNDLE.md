...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-4.83-kirby-problem-4.83-11db468c-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-4.83"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-4.83-kirby-problem-4.83-11db468c-v1",
      "problem_contract_sha256": "040156644fff0b9aeffc1743f2811d98bea9e2957d2701c5cd06cc41aabd0a4d",
      "problem_id": "problem:um-kp-4.83-kirby-problem-4.83-11db468c",
      "route_id": "route:um-kp-4.83-kirby-problem-4.83-11db468c-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-4.83-kirby-problem-4.83-11db468c-source-fidelity-01",
      "graph_id": "graph:um-kp-4.83-kirby-problem-4.83-11db468c-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-4.83-kirby-problem-4.83-11db468c-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-4.83-kirby-problem-4.83-11db468c-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "For which 4-manifolds does there exist a smooth structure such that there exists a non-smoothable homeomorphism with respect to that smooth structure?"
          },
          "statement_sha256": "15d21f81fc9aeafad0451012241f615e21589472c02d4c5daaa6874b9fbb7888"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-4.83-kirby-problem-4.83-11db468c-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-4.83-kirby-problem-4.83-11db468c-root",
      "route_id": "route:um-kp-4.83-kirby-problem-4.83-11db468c-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-4.83-511313f87d00",
        "url": "https://www.unsolvedmath.com/problems/KP-4.83"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
